...
def train_learnlets(**args):
    ...
    # args['model']
    # Paths
    run_id_name = args['run_id_name'] #'learnlet_256'
    eigenpsf_dataset_path = args['dataset_path'] # '/n05data/ayed/outputs/eigenpsfs/dataset_eigenpsfs.fits'
    base_save_path = args['base_save_path'] # '/n05data/tliaudat/new_deepmccd/reproduce_aziz_results/trained_nets/learnlets_256/'
