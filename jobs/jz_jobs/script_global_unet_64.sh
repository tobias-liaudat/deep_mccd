#!/bin/bash
#SBATCH --job-name=global_unet_64    # nom du job
...
srun python -u training_unets.py \
    --run_id_name global_unet_64 \
    --dataset_path /gpfswork/rech/ynx/ulx23va/deep_mccd_project/eigenpsf_datasets/global_eigenpsfs.fits \
    --base_save_path /gpfswork/rech/ynx/ulx23va/deep_mccd_project/trained_models/global_unet_64/ \
    --layers_n_channel 64 \
    --layers_levels 5 \
    --kernel_size 3 \
