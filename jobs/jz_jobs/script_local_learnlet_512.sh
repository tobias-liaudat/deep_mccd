#!/bin/bash
#SBATCH --job-name=local_learnlet_512    # nom du job
...
#SBATCH --output=local_learnlet_512_%j.out  # nom du fichier de sortie
#SBATCH --error=local_learnlet_512_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
