#!/bin/bash
#SBATCH --job-name=global_learnlet_256    # nom du job
...
#SBATCH --output=global_learnlet_256_%j.out  # nom du fichier de sortie
#SBATCH --error=global_learnlet_256_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
srun python -u training_learnlets.py \
    --run_id_name global_learnlet_256 \
    --dataset_path /gpfswork/rech/ynx/ulx23va/deep_mccd_project/eigenpsf_datasets/global_eigenpsfs.fits \
    --base_save_path /gpfswork/rech/ynx/ulx23va/deep_mccd_project/trained_models/global_learnlet_256/ \
    --n_tiling 256 \
    --n_scales 5 \
