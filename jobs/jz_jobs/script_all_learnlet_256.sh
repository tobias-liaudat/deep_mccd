#!/bin/bash
#SBATCH --job-name=all_learnlet_256    # nom du job
...
#SBATCH --output=all_learnlet_256_%j.out  # nom du fichier de sortie
#SBATCH --error=all_learnlet_256_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
srun python -u training_learnlets.py \
    --run_id_name all_learnlet_256 \
    --dataset_path /gpfswork/rech/ynx/ulx23va/deep_mccd_project/eigenpsf_datasets/all_eigenpsfs.fits \
    --base_save_path /gpfswork/rech/ynx/ulx23va/deep_mccd_project/trained_models/all_learnlet_256/ \
    --n_tiling 256 \
    --n_scales 5 \
