...
$SPENV/bin/shapepipe_run -c $CONFDIR/jobs/testing_jobs/testing_configs/test_pipe_classic_mccd_wav0.ini
$SPENV/bin/shapepipe_run -c $CONFDIR/jobs/testing_jobs/testing_configs/test_pipe_classic_mccd_wav1.ini
$SPENV/bin/shapepipe_run -c $CONFDIR/jobs/testing_jobs/testing_configs/test_pipe_classic_mccd_wav3.ini
