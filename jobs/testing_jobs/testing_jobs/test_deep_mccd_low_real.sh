...
#PBS -N test_low_den_deep_mccd
# Join output and errors in one file
#PBS -j oe
# Set maximum computing time (e.g. 5min)
#PBS -l walltime=95:00:00
# Request number of cores
#PBS -l nodes=n16:ppn=3:hasgpu
...
# Flat SNR
/home/tliaudat/.local/bin/shapepipe_run.py -c $CONFDIR/jobs/testing_jobs/testing_configs/test_pipe_deep_mccd_low_den_L256.ini
